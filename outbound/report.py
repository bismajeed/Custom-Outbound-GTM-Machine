...
def _campaign_stats(campaign_id: str) -> dict:
    """Aggregate sent/opened/replied/bounced/unsub from paginated /statistics.

    /statistics returns all emailed leads (active + completed) with engagement
    fields. Paginating it gives the true sent count and correct open/reply rates.
    """
